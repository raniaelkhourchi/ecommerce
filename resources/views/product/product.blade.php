...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            ...
            <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Product List </span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
            ...
            <div class="modal-content">
                ...
                <form action='{{route('product.store')}}'  method="Post">
                    ...
                    <div class="modal-body">
                        ...
                        <label class="my-1 mr-2" for="inlineFormCustomSelectPref"> Type of Sales</label>
                        <select name="section_id" id="section_id" class="form-control" required>
                            <option value="" selected disabled> --chose a type of sales--</option>
