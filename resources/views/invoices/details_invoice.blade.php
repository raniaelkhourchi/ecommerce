...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Invoice List</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                                    ...
                                    <div class="tabs-menu1">
                                        ...
                                        <ul class="nav panel-tabs main-nav-line">
                                            <li><a href="#tab4" class="nav-link active" data-toggle="tab">Invoice
                                                    Information</a></li>
                                            <li><a href="#tab5" class="nav-link" data-toggle="tab">Payment
                                                    Status</a></li>
                                            <li><a href="#tab6" class="nav-link" data-toggle="tab">Attachments</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="tab-content">
                                            ...
                                            <div class="table-responsive mt-15">
                                                ...
                                                <table class="table table-striped" style="text-align:center">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <th scope="row">VAT Percentage</th>
                                                            <td>{{ $invoices->Rate_VAT }}</td>
                                                            <th scope="row">VAT Value</th>
                                        ...
                                        <div class="tab-pane" id="tab6">
                                            ...
                                            <div class="card card-statistics">
                                                @can('Add Attachment')
                                                    <div class="card-body">
                                                        <p class="text-danger">* Attachment formats: pdf, jpeg, jpg, png
                                                        </p>
